  ...
  return (
    ...
    >
      ...
      <Routes>
        <Route
          path="/"
          element={isLoggedIn ? <Home /> : <Navigate to="/register" />}
        />
        <Route
          path="/admin-dashboard"
          element={isLoggedIn ? <AdminHomePage /> : <Navigate to="/register" />}
        />
        <Route
          path="/login"
          element={
        ...
        <Route
          path="/register"
          element={
            <Register isLoggedIn={isLoggedIn} setLoggedIn={setLoggedIn} />
          }
        />
        <Route
          path="/profile"
